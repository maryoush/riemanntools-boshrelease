...
if [[ -d /var/vcap/packages/java_for_riemanntools ]]
then
  export JAVA_HOME="/var/vcap/packages/java_for_riemanntools"
fi
...
PIDFILE=/var/vcap/sys/run/riemann-cassandra/riemann-cassandra_pid
#$RUN_DIR/$JOB_NAME_pid
