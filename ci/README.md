...
Pipeline running at ${CONCOURSE_URL}/riemanntools-boshrelease

Setup pipeline in Concourse
---------------------------

```
fly -t snw c -c pipeline.yml --vars-from credentials.yml riemanntools-boshrelease --paused=false
```
...
```
fly -t snw configure -c ci_image/pipeline.yml --vars-from credentials.yml riemanntools-boshrelease-image --paused=false
```
